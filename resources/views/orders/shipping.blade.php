    ...
    <article class="card">
        <div class="card-body">
            ...
            <div class="card-body row">
                    ...
                    <div class="col"> <strong>@lang('messages.address_page.state'):</strong> <br> {{ucfirst($order->addresses->cities['name'])}} </div>
                    <div class="col"> <strong>@lang('messages.address_page.city'):</strong> <br> {{ucfirst($order->addresses['state'])}} </div>
