        ...
        <div class="card">
            <form >   
                ...
                <div class="card-body row" style="font-size: 18px;">
                    ...
                    <div class="form-group col-6">
                        <label for="lname" class="text-right control-label col-form-label">Status: {{ucfirst($bookmarkPlangug->status == 1 ? "Activate" : "Deactivate")}}</label>
                    </div>
                    <div class="form-group col-6">
                        <label for="lname" class="text-right control-label col-form-label">Feature:{{ucfirst($bookmarkPlangug->featured == 1 ? "featured" : "not featured")}} </label>
                    </div>
