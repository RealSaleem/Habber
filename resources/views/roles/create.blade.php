...
<div class="row">
    <div class="col-lg-12 margin-tb">
        <div class="pull-left">
            <h2>@lang('messages.role_page.add_role')</h2>
        </div>
    </div>
        <div class="container-fluid">
        @if(Session::has('success'))
            <div class="alert alert-success text-center" role="alert">
                <strong>Role Created! &nbsp;</strong>{{Session::get('success')}}
            </div>
        @endif 
            ...
            <form action="{{ action('RoleController@store') }}" method="post" >   
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        <label for="fname" class="col-sm-3 text-right control-label col-form-label">@lang('messages.role_page.role_name')</label>
                        <div class="col-sm-9">
